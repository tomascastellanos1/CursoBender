...
void loop()
{
   ...
   ojo1->fillRect(ojo1X-240 , 95 , 240 , 50 ,ojo1->color565(255, 254, 196));
    ...
    ojo2->fillRect(ojo1X , 95 , 50 , 50 , BLACK);
   ojo2->fillRect(ojo1X+50 , 95 , 240 , 50 , ojo2->color565(255, 254, 196));
   ojo2->fillRect(ojo1X-240 , 95 , 240 , 50 ,ojo2->color565(255, 254, 196));
...
if (!huskylens.request()) Serial.println(F("Fail to request data from HUSKYLENS, recheck the connection!"));
  ...
  ojo1->fillCircle(120,355,200, ojo1->color565(255, 254, 196));
   ojo2->fillCircle(120,355,200, ojo1->color565(255, 254, 196));
 
  }
  else { //si detecta alcohol
  ojo1->fillCircle(120,355,200, BLACK);
  ojo2->fillCircle(120,355,200, BLACK);
  }
